class Options:
    def __init__(self):
        ...
        self.sup_pos = 0.2 # Minimum support in shock group
        self.sup_neg = 0.2 # Minimum support in non-shock group
        ...
        # directory settings
        self.ts_pos_filepath = 'mimic/MIMIC_III_shock.csv'
        self.ts_neg_filepath = 'mimic/MIMIC_III_nonshock.csv'
